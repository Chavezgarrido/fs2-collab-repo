...
function initPlayerControls() {
  ...
  // Alerta "En preparación" para todos los controles de reproducción (incluyendo Play)
  const botonesEnDesarrollo = [playBtn, shuffleBtn, prevBtn, nextBtn, repeatBtn];
  botonesEnDesarrollo.forEach(boton => {
    if (boton) {
